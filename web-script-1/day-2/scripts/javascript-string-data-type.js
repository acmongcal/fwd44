...
const saying = 'I\'ll be back!';

console.log('firstname', firstname);
console.log('lastname', lastname);

// Use typeof [variable name] to show the data type of the variable

console.log(typeof firstname);

// String Concatenation
console.log('Hello' + firstname + ' ' + lastname +'.');
//Concatenate with Template Strings (`)
console.log(`Hello ${firstname} ${lastname}.`);
...
console.log(`Total: $ ${(subTotal + (subTotal *tax.to)).toFixed(2)}`);
